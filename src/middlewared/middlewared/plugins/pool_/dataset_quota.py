...
class PoolDatasetService(Service):
    ...
    @private
    @pass_thread_local_storage
    def get_quota_impl(self, tls, ds, quota_type, access: InternalAccess = InternalAccess.DENY):
        deny_protected_path('pool.dataset.get_quota', ds, access)
    ...
    @private
    @pass_thread_local_storage
    def set_quota_impl(self, tls, ds, inquotas, access: InternalAccess = InternalAccess.DENY):
        deny_protected_path('pool.dataset.set_quota', ds, access)
